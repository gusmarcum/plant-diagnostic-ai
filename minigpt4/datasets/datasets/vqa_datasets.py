...
class VQADataset(BaseDataset):
    def __init__(self, vis_processor, text_processor, vis_root, ann_paths):
        # Handle vis_root as list or string
        if isinstance(vis_root, (list, tuple)):
            self.vis_root = vis_root[0]  # Use first path if multiple provided
        else:
        ...
        # Load and combine annotations from all paths
        self.annotation = []
        if isinstance(ann_paths, (list, tuple)):

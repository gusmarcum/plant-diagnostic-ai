...
default_cfg_path = os.path.join(repo_root, "/data/kiriti/MiniGPT-4/eval_configs/minigptv2_eval.yaml")  # Adjust path if necessary
...
default_cfg.env = default_cfg.get("env", {"cache_root": "/data/kiriti/MiniGPT-4/cache"})
